...
<div class="smartdocs-wrap smartdocs-taxonomy-container">
	<div class="smartdocs-category-content-area">
		<div class="smartdocs-category-header">
			<h1 class="smartdocs-title"><?php single_cat_title(); ?></h1>
			<?php the_archive_description( '<div class="smartdocs-taxonomy-description">', '</div>' ); ?>
			<?php
			if ( function_exists( 'yoast_breadcrumb' ) ) {
				echo '<div class="smartdocs-tax-breadcrumb">' . do_shortcode( '[wpseo_breadcrumb]' ) . '</div>';
			}
			?>
		</div>
		...
		<div class="smartdocs-archive-post-container">

			<?php if ( $terms_children ) : ?>
			<div class="smartdocs-categories-wrap">
				<?php
				// Looping through all the terms.
				foreach ( $terms_children as $t ) {
					?>

					<div class="smartdocs-categories-post">
						<a href="<?php echo esc_html( get_term_link( $t ) ); ?>" class="smartdocs-sub-archive-post">
		...
		if ( have_posts() ) :
			...
			?>
			<div class="smartdocs-post-container">
			<?php
			while ( $query->have_posts() ) :
				...
				<article id="post-<?php the_ID(); ?>">
					...
					<h3 class="smartdocs-entry-title">
