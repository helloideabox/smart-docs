...
function Tabs() {
  var tabClasses = "sd-setting-primary-tab px-4 text-sm";
...
/* harmony import */ var _utils_save__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/save */ "./src/settings/utils/save.js");
...
function Search() {
  ...
  var _useEntityProp = Object(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_5__["useEntityProp"])("root", "site", "ibx_sd_search_post_types"),
  ...
  var _useState = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useState"])(false),
      ...
      saving = _useState2[0],
      setSaving = _useState2[1]; // 1. Array to store previously selected post types


  var _useState3 = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useState"])(postTypes),
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["BaseControl"], {
    id: "textarea-1",
    label: "Select Post Types",
    help: "Select post types to search in.",
    className: "mb-3"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("ul", null, Object.keys(sd_vars.post_types).map(function (item, index) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("li", {
      ...
      checked: types.some(function (value) {
        return value === item;
      }),
      onChange: function onChange(isChecked) {
        if (isChecked) {
          setTypes(function (types) {
            return [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(types), [item]);
          });
        } else {
          var u = [];
          u = types.filter(function (type) {
            return type !== item;
          });
          setTypes(u);
        }
...
function SaveSettings(settings) {
  var _useDispatch = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__["useDispatch"])("core/notices"),
      createSuccessNotice = _useDispatch.createSuccessNotice,
      createErrorNotice = _useDispatch.createErrorNotice;

  wp.data.dispatch("core").saveSite(settings).then(function () {
    createSuccessNotice("Settings Saved!", {
      type: "snackbar"
    });
  }).catch(function (e) {
